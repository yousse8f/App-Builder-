      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
          ...
          <p className="text-xl text-indigo-100 text-center max-w-md">
            Build amazing applications with ease. Your journey starts here.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 text-center space-y-3 text-sm">
            ...
            <p className="text-gray-600">
              {t.auth.adminPrompt}{' '}
              <Link href="/admin/login" className="font-medium text-indigo-600 hover:text-indigo-700 transition-colors">
                {t.auth.adminTitle}
              </Link>
            </p>
          </div>
