...
export const translations = {
  en: {
    ...
    features: {
      ...
      items: [
        ...
        { title: 'Ready-made Templates', description: 'Start faster with professionally designed templates for various industries.' },
        ...
        { title: 'Client Dashboard', description: 'Monitor projects, builds, templates, and account information.' },
      ],
    },
    howItWorks: {
      ...
      steps: [
        ...
        { title: 'Choose a template', description: 'Select from professionally designed templates to get started fast.' },
    ...
    templates: {
      title: 'Start with a template. Make it yours.',
      subtitle: 'Choose from professionally designed templates to accelerate your development',
      preview: 'Preview',
      comingSoon: 'Template system coming soon',
      items: [
        { name: 'Business', category: 'Professional', description: 'Corporate and business applications with professional features.' },
        { name: 'Restaurant', category: 'Food & Beverage', description: 'Complete restaurant management and ordering system.' },
        { name: 'E-commerce', category: 'Retail', description: 'Full-featured online store with payment integration.' },
        { name: 'Education', category: 'Learning', description: 'Educational platforms and learning management systems.' },
        { name: 'Community', category: 'Social', description: 'Community building and social networking features.' },
        { name: 'Services', category: 'Business', description: 'Service booking and management applications.' },
      ],
    },
    pricing: {
      ...
      plans: [
        { name: 'Starter', description: 'Perfect for individuals and small projects', price: 'Coming Soon', features: ['Up to 3 projects', 'Basic templates', 'Community support', 'Build management', 'License management', 'Priority support'] },
        { name: 'Professional', description: 'For growing businesses and teams', price: 'Coming Soon', features: ['Unlimited projects', 'All templates', 'Priority support', 'Build management', 'License management', 'Team collaboration'] },
        { name: 'Business', description: 'For large organizations and enterprises', price: 'Coming Soon', features: ['Unlimited projects', 'All templates', '24/7 dedicated support', 'Build management', 'License management', 'Team collaboration'] },
      ],
    },
    productPreview: {
      ...
      projects: [
        { name: 'E-Commerce App', platform: 'iOS & Android', template: 'Business', status: 'Active', license: 'Active' },
        { name: 'Restaurant App', platform: 'iOS & Android', template: 'Restaurant', status: 'Building', license: 'Active' },
        { name: 'Fitness Tracker', platform: 'iOS Only', template: 'Health', status: 'Draft', license: 'Pending' },
        { name: 'Community Portal', platform: 'iOS & Android', template: 'Community', status: 'Active', license: 'Active' },
      ],
    },
    security: {
    ...
    faq: {
      ...
      items: [
        { question: 'What is App Builder?', answer: 'App Builder is a SaaS platform that allows clients to create and manage mobile applications through a centralized platform. It provides tools for project management, template selection, application customization, and build preparation.' },
    ...
    dashboard: {
      ...
      gettingStarted: {
        ...
        step2Desc: 'Select from our professionally designed templates',
        step3Title: 'Customize and build',
        step3Desc: 'Tailor your app and prepare for deployment',
  ...
  es: {
    ...
    features: { title: 'Todo lo que necesitas para crear y gestionar tus apps', subtitle: 'Herramientas potentes para simplificar el desarrollo de aplicaciones móviles', available: 'Disponible', comingSoon: 'Próximamente', items: [{ title: 'Creación visual de apps', description: 'Construye proyectos de aplicación desde una plataforma centralizada con herramientas intuitivas.' }, { title: 'Plantillas listas para usar', description: 'Empieza más rápido con plantillas diseñadas profesionalmente para distintas industrias.' }, { title: 'Gestión de proyectos', description: 'Mantén todas tus aplicaciones y proyectos organizados en un mismo espacio de trabajo.' }, { title: 'Compilaciones automatizadas', description: 'Prepara compilaciones de aplicaciones mediante un flujo centralizado.' }, { title: 'Gestión de licencias', description: 'Administra licencias y activaciones de aplicaciones desde un solo lugar.' }, { title: 'Panel del cliente', description: 'Supervisa proyectos, compilaciones, plantillas e información de la cuenta.' }] },
    howItWorks: { title: 'De la idea a la aplicación en cuatro pasos sencillos', subtitle: 'Flujo optimizado para llevarte desde el concepto hasta la aplicación desplegada', steps: [{ title: 'Crea tu cuenta', description: 'Regístrate y configura tu espacio de trabajo de App Builder en minutos.' }, { title: 'Elige una plantilla', description: 'Selecciona plantillas diseñadas profesionalmente para empezar rápidamente.' }, { title: 'Personaliza tu aplicación', description: 'Adapta la app a tus necesidades con herramientas intuitivas.' }, { title: 'Construye y gestiona tu app', description: 'Prepara compilaciones y gestiona el ciclo de vida de tu aplicación.' }] },
    templates: { title: 'Empieza con una plantilla. Hazla tuya.', subtitle: 'Elige plantillas diseñadas profesionalmente para acelerar tu desarrollo', preview: 'Vista previa', comingSoon: 'El sistema de plantillas estará disponible pronto', items: [{ name: 'Negocios', category: 'Profesional', description: 'Aplicaciones corporativas y empresariales con funciones profesionales.' }, { name: 'Restaurante', category: 'Alimentación', description: 'Sistema completo de gestión y pedidos para restaurantes.' }, { name: 'E-commerce', category: 'Retail', description: 'Tienda online completa con integración de pagos.' }, { name: 'Educación', category: 'Aprendizaje', description: 'Plataformas educativas y sistemas de gestión del aprendizaje.' }, { name: 'Comunidad', category: 'Social', description: 'Construcción de comunidades y funciones sociales.' }, { name: 'Servicios', category: 'Negocios', description: 'Aplicaciones de reserva y gestión de servicios.' }] },
    pricing: { title: 'Precios simples y transparentes', subtitle: 'Elige el plan que mejor se adapte a tus necesidades. Todos incluyen funciones esenciales.', badge: 'Los planes estarán disponibles pronto', popular: 'Popular', cta: 'Comenzar', notify: 'Recibir notificación', comingSoonTitle: 'Los planes flexibles llegarán pronto', comingSoonDescription: 'Estamos definiendo nuestra estructura de precios. Nuestro objetivo es ofrecer opciones flexibles para distintos perfiles, desde desarrolladores individuales hasta empresas.', plans: [{ name: 'Inicial', description: 'Perfecto para individuos y proyectos pequeños', price: 'Próximamente', features: ['Hasta 3 proyectos', 'Plantillas básicas', 'Soporte de la comunidad', 'Gestión de compilaciones', 'Gestión de licencias', 'Soporte prioritario'] }, { name: 'Profesional', description: 'Para negocios en crecimiento y equipos', price: 'Próximamente', features: ['Proyectos ilimitados', 'Todas las plantillas', 'Soporte prioritario', 'Gestión de compilaciones', 'Gestión de licencias', 'Colaboración en equipo'] }, { name: 'Empresarial', description: 'Para organizaciones grandes y empresas', price: 'Próximamente', features: ['Proyectos ilimitados', 'Todas las plantillas', 'Soporte dedicado 24/7', 'Gestión de compilaciones', 'Gestión de licencias', 'Colaboración en equipo'] }] },
    productPreview: { title: 'Todo en un mismo espacio de trabajo', subtitle: 'Gestiona todo tu flujo de desarrollo desde un único panel', stats: { totalProjects: 'Total de proyectos', active: 'Activos', building: 'En construcción', drafts: 'Borradores' }, table: { project: 'Proyecto', platform: 'Plataforma', template: 'Plantilla', status: 'Estado', license: 'Licencia' }, projects: [{ name: 'App de comercio', platform: 'iOS y Android', template: 'Negocios', status: 'Activo', license: 'Activo' }, { name: 'App de restaurante', platform: 'iOS y Android', template: 'Restaurante', status: 'En construcción', license: 'Activo' }, { name: 'Rastreador fitness', platform: 'Solo iOS', template: 'Salud', status: 'Borrador', license: 'Pendiente' }, { name: 'Portal comunitario', platform: 'iOS y Android', template: 'Comunidad', status: 'Activo', license: 'Activo' }] },
